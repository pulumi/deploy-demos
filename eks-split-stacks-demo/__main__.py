"""EKS cluster stack - uses network stack for VPC resources.

After state migration, this stack references the network stack for VPC info
instead of creating the VPC directly.
"""
